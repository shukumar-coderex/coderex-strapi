...
import RelatedPost from '../../src/components/RelatedPost';
import SinglePost from '../../src/components/blog/Single';
	...
	return (
		<Layout data={data} isPost>
			<div className="single">
                ...
                <RelatedPost categories={data?.post?.categories?.nodes}/>
				<CallToAction cta={data?.siteCta} />
			</div>
		</Layout>
	);
};
