                ...
                {socialLinks &&
                    <ul className="container-fluid cr-social-link">
                        { socialLinks.facebook &&
                            <li>
                                <a href={socialLinks.facebook} target="_blank" title="Facebook">
                        ...
                        { socialLinks.twitter &&
                        <li>
                                <a href={socialLinks.twitter} target="_blank" title="Twitter">
                        ...
                        { socialLinks.linkedin &&
                            <li>
                                <a href={socialLinks.linkedin} target="_blank" title="Linkedin">
