...
const Single = ( {post} ) => {
	return (
		<Fragment>
			<section className="inner-page-banner blog-single-banner pos-relative" style={{backgroundImage: `url(${post?.featuredImage?.node?.sourceUrl})`}}>
            ...
            <section className="blog-details entry">
                <div className="cr-container">
                    <div className="cr-row">
                        <div className="cr-col">
                            <div className="details-content-wrapper">
                                <div className="content-header">
                                                ...
                                                return (
                                                    <li className="texonomy" key={index}>
                                                        <Link
                                                            ...
                                                            href={'/category/[slug]'}
                                                        >
                                                            <a key={index} className="circular-700 color-fff text-uppercase tag">{ ( index ? '' : '' ) + term.name}<span> ,</span></a>
                                                        </Link>
                                                    </li>
                                                );
                                            } )
                                    ...
                                    <h1 className="circular-700" dangerouslySetInnerHTML={{__html: sanitize( post?.title ?? '' )}}/>
                                </div>
                                ...
                                <div className="content-text">
                                    <ul className="social-share desktop-device" id="blog-single-social">
                                        ...
                                        <li className="facebook">
                                            <a href={`https://www.facebook.com/sharer/sharer.php?u=https://coderex.co/blog/${post?.slug}`} target="_blank" title="Facebook">
                                        ...
                                        <li className="twitter">
                                            <a href={`https://twitter.com/home?status=https://coderex.co/blog/${post?.slug}`} target="_blank" title="Twitter">
                                        ...
                                        <li className="linkedin">
                                            <a href={`https://www.linkedin.com/shareArticle?mini=true&url=https://coderex.co/blog/${post?.slug}&title=${post.title}&summary=&source=`} target="_blank" title="Linkedin">
                                        ...
                                        <li className="pinterest">
                                            <a href={`https://pinterest.com/pin/create/button/?url=https://coderex.co/blog/${post?.slug}&media=&description=`} target="_blank" title="Linkedin">
                                    ...
                                    <div className="the-content entry-content">
                                        ...
                                        <ul className="social-share mobile-device">
                                            ...
                                            <li className="pinterest">
                                                <a href="" target="_blank" title="Linkedin">
                                                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="pinterest" className="svg-inline--fa fa-pinterest fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                                        ...
                                        {/* comment component */}
                                        <Comments postComments={post?.comments?.nodes} postID={post?.databaseId}/>
                                    </div>
                                </div>
                            </div>
                        </div>
